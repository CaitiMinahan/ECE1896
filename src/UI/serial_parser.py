...
# TODO: create a function named parser
    ...
    # take in the hex value input and use a Python library to convert the hex -> binary
        ...
        # 110 - FAULTS
            ...
            # (i.e., if and elif statements checking if module == 0000 through 1111 (0-F))
            ...
            # NOTE: for I'D's 101-110, module = input[15], input[14], input[13], input[12]
                ...
                # (i.e., if and elif statements checking if cell == 0000 through 1100 (0-C))
                ...
                # NOTE: for I'D's 101-110, module = input[11], input[10], input[9], input[8]
                    ...
                    # (i.e., use a python library for checking if the entire digits contains a decimal or not)
                        # TODO: if there is a decimal, assign the V, I, T, SOC or SOP to a variable (possibly tuple) containing the module, cell and reported value
                        # (i.e., read in the last portion of the input data and assign it to a variable)
                        # NOTE: for ID'S 000-100, module = input[15], through input[0]
                        # TODO: if there is NOT a decimal, assign SOH or FAULTS to a variable containing module, cell and reported value
                        # (i.e., read in the last portion of the input data and assign it to a variable)
                        # NOTE: for I'D's 101-110, module = input[7] through input[0]
# TODO: return the parsed value for the function to be called when updating the GUI
